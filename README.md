# Alis
A SEGA Master System emulator. This is an SDL port of an old university
graduation project. The original version was written for Windows and
DirectX in 2002.

The first version of the core was written in 32bits x86 assembly and later
converted to 64bits x86 assembly. It was funny, but not portable. So, I
decided to write everything again in C. A lot of features from previous
version is still not available yet in this version, but it will be some
day...
